...
rsync -r -t -p -o -g -x --delete -l -z -s -e ssh --exclude-from=/home/mua/.backupignore --log-file=$HOME/.rsync_backup/rsync-log-$(date +%u)  -h /home/mua mua@192.168.252.254::NetBackup/$(date +%u)/
if [ $? -ne 0 ]
then
